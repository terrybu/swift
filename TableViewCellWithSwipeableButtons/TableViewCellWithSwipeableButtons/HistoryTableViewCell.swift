...
class HistoryTableViewCell : UITableViewCell, UIGestureRecognizerDelegate
{
    ...
    */
    func setValuesForRecord(string: String)
    {
        clientLabel.text = kClientLabelPrefix + string
        projectLabel.text = kProjectLabelPrefix + string
        hoursLabel.text = kHoursLabelPrefix + string
    }
